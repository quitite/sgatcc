...
export class ResourcesServiceProxy {
    ...
    get(id: number | undefined): Observable<ResourceDto> {
        let url_ = this.baseUrl + "/api/services/app/Resources/Get?";
        if (id === null)
     ...
     * @return Success
     */
    getAll(sorting: string | null | undefined, skipCount: number | undefined, maxResultCount: number | undefined): Observable<ResourceDtoPagedResultDto> {
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                ...
                return <Observable<ResourceDtoPagedResultDto>><any>_observableThrow(response_);
        }));
    }
    ...
    create(body: ResourceDto | undefined): Observable<ResourceDto> {
        let url_ = this.baseUrl + "/api/services/app/Resources/Create";
        url_ = url_.replace(/[?&]$/, "");
    ...
    update(body: ResourceDto | undefined): Observable<ResourceDto> {
        let url_ = this.baseUrl + "/api/services/app/Resources/Update";
        url_ = url_.replace(/[?&]$/, "");
...
export class ResourceDto implements IResourceDto {
    ...
    init(_data?: any) {
        if (_data) {
            this.nomeAtivo = _data["nomeAtivo"];
            this.areaResponsavel = _data["areaResponsavel"];
            this.dataEntrada = _data["dataEntrada"] ? moment(_data["dataEntrada"].toString()) : <any>undefined;
            this.bLiquidado = _data["bLiquidado"];
            this.id = _data["id"];
        }
    }
    ...
    toJSON(data?: any) {
        data = typeof data === 'object' ? data : {};
        data["nomeAtivo"] = this.nomeAtivo;
        data["areaResponsavel"] = this.areaResponsavel;
        data["dataEntrada"] = this.dataEntrada ? this.dataEntrada.toISOString() : <any>undefined;
        data["bLiquidado"] = this.bLiquidado;
        data["id"] = this.id;
        return data; 
    }
        ...
        if (_data) {
            ...
            if (Array.isArray(_data["items"])) {
                ...
                for (let item of _data["items"])
                    this.items.push(ResourceDto.fromJS(item));
            }
        }
    }
